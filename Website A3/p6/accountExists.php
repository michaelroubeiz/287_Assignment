...
<body>
<br /><br />
       <h1 style="margin: 40px">Looks like your account already exists...</h1> 
       <p style="margin: 40px">No worries, click the login in button to continue or click the back button to go back.</p>
        <br /><br /><input style="margin-left: 40px" class="btn btn-secondary" type="submit" value="Log In" />
        <input style="margin-left: 40px" class="btn btn-secondary" type="submit" value="Back" />
        <style>
            .btn
            {
